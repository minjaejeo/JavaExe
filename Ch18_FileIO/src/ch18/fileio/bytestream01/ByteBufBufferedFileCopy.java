 ...
 * 
 * ex) putty.exe파일 기준으로 약 7.5초
 * 이것을 개선하려면 3가지
 * 1) 한번에 많이 읽기(11/1000초)(9320ms)
 * 2) jdk 입력 버퍼 클래스를 사용해서 미리 읽어들인 것을 1byte씩 가져오고
 * 	다시 출력 버퍼 클래스에 1byte씩 저장하면 알아서 파일에 한꺼번에 저장(45/1000초)
 * 3) 1)번과 2)번 합치기 (putty.exe : 5/1000ch) (Healing.mp4 : 8511ms)
 */
/*
 * 물류시스템과 동일
 * 하드디스크(물류센터)
...
public class ByteBufBufferedFileCopy {
	public static void main(String[] args) throws IOException {
		...
		/*1024byte씩 입출력하고 버퍼필터클래스를 동시에 사용한다.*/
		long copyByte = 0;
		int readLen = 0;
