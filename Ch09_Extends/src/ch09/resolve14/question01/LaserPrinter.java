...
public class LaserPrinter extends Printer {
	...
	public LaserPrinter(String modelName, String menufacturer, P_INTERFACE pInterface, int printCount,
	...
	public String toString() {
		return "LaserPrinter [tonnerRemainders=" + tonnerRemainders + ", modelName=" + modelName + ", menufacturer="
