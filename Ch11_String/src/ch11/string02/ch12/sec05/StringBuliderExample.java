		...
		class MyStringBuilder{
			...
			public MyStringBuilder append(String str) {
				...
				for(char ch : chArr)
					 ...
					 * char -> Character 클래스로 변환된다.
					 * Character 클래스 내부에는 char 를 보관하고 있다.
					 * ch 값은 결국 객체로 변환되어 힙으로 이동한다.
					 * 
					 * 성능의 저하 현상
					 */
			...
			public String toString() {
				...
				/*
				 * UnBoxing 현상 발생
				 * chList 내부에서 Character 클래스 객체로 힙공간에 보관하다가
				 * 지역변수 char ch 에 대입할 때 다시 스택에 존재하는 ch 로 값을 전달한다.
				 */
				for(char ch : chList)
					str += ch;
				return str;
